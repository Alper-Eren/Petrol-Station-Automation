...
public class Login extends javax.swing.JFrame {
    ...
    private void girisYapButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisYapButtonActionPerformed
        ...
        ResultSet rs = connection.executeQuery("select * from Personel where personelNo='" + Integer.parseInt(kullaniciAdi.getText()) + "'and personelTipi=1 and sifre='" + sifre.getText() + "'");

        try {
            if (rs.next()) {
                dispose();
                PompaciView pm = new PompaciView(kullaniciAdi.getText());
                pm.setVisible(true);
